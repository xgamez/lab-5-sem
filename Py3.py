import json
from py35 import print_result
from py33 import Unique
from py31 import field
from py32 import gen_random
from py36 import cm_timer_1

path = '/Users/Xgamez/source/repos/Py3/Py3/data_light.json'
